...
class TestBidsViews(TestCase):
    ...
    #                            history="It happened a long time ago",
    #                            description="It is really old", era="AD",
    #                            sold=False, despatched=False)
    #        artefact.save()
    #
    #        customer = Customer(full_name="Pippy Longstockings",
    #                            user=user_instance,
    #                            street_Address1="10 Any Street",
    #                            street_Address2="Any Area",
    #                            town_or_city="Dublin",
    #                            county="Dublin",
    #                            country="Ireland",
    #                            postcode="D01EO90",
