...
from .views import for_sale_artefacts, artefact_detail, add_artefact,\
                    edit_artefact_detail, delete_artefact, sold_artefacts,\
                    despatched_artefacts, despatch_artefact, past_purchases
...
urlpatterns = [
    ...
    url(r'^edit/(?P<id>\d+)/$', edit_artefact_detail,
        name='edit_artefact_detail'),
    url(r'^delete/(?P<id>\d+)/$', delete_artefact, name='delete_artefact'),
    url(r'^despatch/(?P<id>\d+)/$', despatch_artefact,
        name='despatch_artefact'),
